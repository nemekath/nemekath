...
- **[kuzco.cpp](https://github.com/nemekath/kuzco.cpp)** -- Custom GEMV kernels for AMD RDNA3 GPUs. +10-36% token generation throughput for quantized LLM inference. Independent llama.cpp fork with 17 quant types validated across 26 models. [Release v1.0.0](https://github.com/nemekath/kuzco.cpp/releases/tag/v1.0.0)
...
GPU kernel optimization -- Systems-level performance -- PKI & certificate infrastructure -- GDPR-compliant analytics -- AI-assisted development workflows -- COM Interop & legacy system integration
...
*Based in Germany. Currently deep-diving into GPU performance engineering, RAG pipelines, and AI MCP development. Occasional tabletop RPG player when not debugging production systems.*
